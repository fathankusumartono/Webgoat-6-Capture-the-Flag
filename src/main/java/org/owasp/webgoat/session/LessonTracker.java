...
public class LessonTracker
{
	...
	private int validA1 = 1;
	private int validA2 = 1;
	private int validA3 = 1;
	private int validA4 = 1;
	private int validA5 = 1;
	private int validA6 = 1;
	private int validA7 = 1;
	private int validA8 = 1;
	private int validA9 = 1;
	private int validA10 = 1;
	...
	public void tambahFinalScore(int score)
	{
		finalScore += score;
	}
	...
	public int getValid(int validIndex)
	{
		int valid = 0;
	...
	protected void setProperties(Properties props, Screen screen)
	{
		...
		finalScore = Integer.parseInt(props.getProperty(screen.getTitle() + ".finalScore", "0"));
		validA1 = Integer.parseInt(props.getProperty(screen.getTitle() + ".validA1", "1"));
		validA2 = Integer.parseInt(props.getProperty(screen.getTitle() + ".validA2", "1"));
		validA3 = Integer.parseInt(props.getProperty(screen.getTitle() + ".validA3", "1"));
		validA4 = Integer.parseInt(props.getProperty(screen.getTitle() + ".validA4", "1"));
		validA5 = Integer.parseInt(props.getProperty(screen.getTitle() + ".validA5", "1"));
		validA6 = Integer.parseInt(props.getProperty(screen.getTitle() + ".validA6", "1"));
		validA7 = Integer.parseInt(props.getProperty(screen.getTitle() + ".validA7", "1"));
		validA8 = Integer.parseInt(props.getProperty(screen.getTitle() + ".validA8", "1"));
		validA9 = Integer.parseInt(props.getProperty(screen.getTitle() + ".validA9", "1"));
		validA10 = Integer.parseInt(props.getProperty(screen.getTitle() + ".validA10", "1"));
	}
	...
	public void store(WebSession s, Screen screen, String user)
	{
		...
		lessonProperties.setProperty(screen.getTitle() + ".finalScore", Integer.toString(finalScore));
		lessonProperties.setProperty(screen.getTitle() + ".validA1", Integer.toString(validA1));
		lessonProperties.setProperty(screen.getTitle() + ".validA2", Integer.toString(validA2));
		lessonProperties.setProperty(screen.getTitle() + ".validA3", Integer.toString(validA3));
		lessonProperties.setProperty(screen.getTitle() + ".validA4", Integer.toString(validA4));
		lessonProperties.setProperty(screen.getTitle() + ".validA5", Integer.toString(validA5));
		lessonProperties.setProperty(screen.getTitle() + ".validA6", Integer.toString(validA6));
		lessonProperties.setProperty(screen.getTitle() + ".validA7", Integer.toString(validA7));
		lessonProperties.setProperty(screen.getTitle() + ".validA8", Integer.toString(validA8));
		lessonProperties.setProperty(screen.getTitle() + ".validA9", Integer.toString(validA9));
		lessonProperties.setProperty(screen.getTitle() + ".validA10", Integer.toString(validA10));
		try
		{
	...
	public String toString()
	{
		...
		buff.append("    - finalScore:......... " + finalScore + "\n" + "\n");
		buff.append("    - validA1:............ " + validA1 + "\n" + "\n");
		buff.append("    - validA2:............ " + validA2 + "\n" + "\n");
		buff.append("    - validA3:............ " + validA3 + "\n" + "\n");
		buff.append("    - validA4:............ " + validA4 + "\n" + "\n");
		buff.append("    - validA5:............ " + validA5 + "\n" + "\n");
		buff.append("    - validA6:............ " + validA6 + "\n" + "\n");
		buff.append("    - validA7:............ " + validA7 + "\n" + "\n");
		buff.append("    - validA8:............ " + validA8 + "\n" + "\n");
		buff.append("    - validA9:............ " + validA9 + "\n" + "\n");
		buff.append("    - validA10:............ " + validA10 + "\n" + "\n");
